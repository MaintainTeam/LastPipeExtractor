...
public class RumbleSearchQueryHandlerFactoryTest {
    ...
    public void testRegularValues() throws Exception {
        ...
        assertEquals("https://rumble.com/search/video?q=Mark+Dice", Rumble.getSearchQHFactory().fromQuery("Mark Dice").getUrl());
        assertEquals("https://rumble.com/search/video?q=paul", Rumble.getSearchQHFactory().fromQuery("paul").getUrl());
    }
    ...
    public void testWithContentfilter() throws Exception {
        assertEquals("https://rumble.com/search/channel?q=%C3%B6%C3%A4%C3%BC", Rumble.getSearchQHFactory()
                .fromQuery("öäü", asList(new String[]{CHANNELS}), EMPTY_STRING).getUrl());
        assertEquals("https://rumble.com/search/video?q=%C3%B6%C3%A4%C3%BC", Rumble.getSearchQHFactory()
